...
public class BiofilterRenderer extends KineticBlockEntityRenderer<BiofilterBlockEntity> {

    public BiofilterRenderer(BlockEntityRendererProvider.Context ctx) {
        super(ctx);
    }

    @Override
    protected void renderSafe(BiofilterBlockEntity be, float partialTicks, PoseStack ms,
