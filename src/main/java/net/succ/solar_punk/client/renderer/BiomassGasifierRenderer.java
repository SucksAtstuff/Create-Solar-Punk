...
public class BiomassGasifierRenderer extends KineticBlockEntityRenderer<BiomassGasifierBlockEntity> {

    public BiomassGasifierRenderer(BlockEntityRendererProvider.Context ctx) {
        super(ctx);
    }

    @Override
    protected void renderSafe(BiomassGasifierBlockEntity be, float partialTicks, PoseStack ms,
