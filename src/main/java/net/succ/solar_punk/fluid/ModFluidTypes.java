...
public class ModFluidTypes {
    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(NeoForgeRegistries.Keys.FLUID_TYPES, SolarPunk.MODID);

    public static final ResourceLocation MOLTEN_SALT_STILL =
            ResourceLocation.fromNamespaceAndPath(SolarPunk.MODID, "block/molten_salt_still");
