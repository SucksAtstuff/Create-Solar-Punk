package net.succ.solar_punk.block.entity;
...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FireboxBoilerBlockEntity>> FIREBOX_BOILER =
            BLOCK_ENTITIES.register("firebox_boiler", () -> BlockEntityType.Builder
                    .of((pos, state) -> new FireboxBoilerBlockEntity(ModBlockEntities.FIREBOX_BOILER.get(), pos, state), ModBlocks.FIREBOX_BOILER.get())
                    .build(null));
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SolarMirrorBlockEntity>> SOLAR_MIRROR =
            BLOCK_ENTITIES.register("solar_mirror", () -> BlockEntityType.Builder
                    .of((pos, state) -> new SolarMirrorBlockEntity(ModBlockEntities.SOLAR_MIRROR.get(), pos, state), ModBlocks.SOLAR_MIRROR.get())
                    .build(null));
